...
public partial class _UnitDetials : System.Web.UI.Page
{
    ...
    public static string getUnitData(Unit id)
    {
        ...
        using (
            SqlCommand cmd =
                new SqlCommand("SELECT u.U_id,u.U_name, Units_Rooms.U_id, COUNT(Units_Rooms.R_id) AS  RoomsNum from Units_Rooms RIGHT JOIN Units as u On u.U_id = @U_id and Units_Rooms.U_id = u.U_id GROUP BY Units_Rooms.U_id, u.U_id,u.U_name",
                    con)
        )
        {
