...
public partial class _Handover : System.Web.UI.Page
{
    ...
    public static string getUnitDashData(user chargeNurse)
    {
        ...
        using (SqlCommand cmd = new SqlCommand("select TOP(20) * from Endorsement_UnitsDashboard where Receive_ChargeNurse_id = @Receive_ChargeNurse_id and Shift_date >=   DATEADD(day,-2, GETDATE()) order by id desc", con))
        {
