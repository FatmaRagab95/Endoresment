            ...
            <div class="cu-form-group special" style="max-width: 900px">
              ...
              <div class="cu-field">
                ...
                <div class="f-select">
                  <select
                    class="form-control form-control-sm"
                    v-model="newUnit.Endorsing_ChargeNurse_id"
                    required
                  >
                    <option
              ...
              <div class="cu-field">
                ...
                <div class="f-select">
                  <select
                    class="form-control form-control-sm"
                    v-model="newUnit.Receive_ChargeNurse_id"
                    required
                  >
                    <option
                      v-for="Nurse in Nurses"
  ...
  methods: {
    submitUnit() {
      if ($("form").is(":valid")) {
        ...
        that.newUnit.Receive_ChargeNurse = that.Nurses.filter(
          (x) => x.Emp_ID == that.newUnit.Receive_ChargeNurse_id
        )[0].FullName;

        that.newUnit.Unit_name = that.Units.filter(
          (x) => x.U_id == that.newUnit.Unit_id
        )[0].U_name;
